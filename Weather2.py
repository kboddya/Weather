...
owm = OWM('b57da7a65340381f8cabd14555c9dee3', config_dict )
...
def handle(call):
        ...
        bot.send_message(call.message.chat.id, 'Місто {city}: '.format(city = (call.data)) + str(w.detailed_status) + ' ' + str(w.temperature('celsius')['temp']) + '°C ' )
